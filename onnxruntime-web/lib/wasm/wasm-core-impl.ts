 ...
 *
 * @param numThreadsIntra SetGlobalIntraOpNumThreads(numThreadsIntra)
 * @param numThreadsInter SetGlobalInterOpNumThreads(numThreadsInter)
 * @param loggingLevel CreateEnv(static_cast<OrtLoggingLevel>(logging_level))
 */
const initOrt = (numThreadsIntra: number, numThreadsInter: number, loggingLevel: number): void => {
...
export const initRuntime = async(env: Env): Promise<void> => {
  // init ORT
  initOrt(env.wasm.numThreads!, 1, logLevelStringToEnum(env.logLevel));
};
